...
static constexpr auto qt_meta_stringdata_ZN8TaskViewE = QtMocHelpers::stringData(
    "TaskView"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8TaskViewE[] = {
...
Q_CONSTINIT const QMetaObject TaskView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8TaskViewE.offsetsAndSizes,
    qt_meta_data_ZN8TaskViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8TaskViewE_t,
        // Q_OBJECT / Q_GADGET
...
void *TaskView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8TaskViewE.stringdata0))
